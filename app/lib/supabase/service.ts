...
// purpose. Only app/lib/ai/ and the service-role functions in
// app/lib/db/triage.ts may import it. Never pass a client-supplied ticket id
// into a service-role read without the caller having already proven it may
// see that ticket.
